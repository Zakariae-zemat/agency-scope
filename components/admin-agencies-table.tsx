        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex flex-1 gap-2">
            ...
            <button 
              ...
              disabled={isPending}
              className="px-4 h-10 bg-cyan-600 dark:bg-cyan-500 text-white text-sm font-medium rounded-lg hover:bg-cyan-700 dark:hover:bg-cyan-600 disabled:opacity-50 transition-all"
            >
              Search
            </button>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <div className="flex items-center border border-slate-300 dark:border-slate-700 rounded-lg overflow-hidden">
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-2 text-sm font-medium border-l border-slate-300 dark:border-slate-700 transition-all ${
                  viewMode === 'grid' 
                    ? 'bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-slate-100' 
                    : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-50 dark:hover:bg-slate-800'
                }`}
            ...
            <select
              ...
              className="h-10 px-3 border border-slate-300 dark:border-slate-700 rounded-lg focus:border-cyan-500 dark:focus:border-cyan-500 focus:outline-none text-sm font-medium bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100"
            >
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-slate-200 dark:border-slate-700">
                      ...
                      <th className="px-6 py-3 text-left">
                        <span className="text-xs font-black text-slate-600 dark:text-slate-400 uppercase tracking-wider">Location</span>
                      </th>
                  ...
                  <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                    {agencies.map((agency) => (
                      <tr key={agency.id} className="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                        ...
                        <td className="px-6 py-4 text-right">
                          {agency.website ? (
                            <a
                              ...
                              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-cyan-600 dark:bg-cyan-500 text-white font-bold hover:bg-cyan-700 dark:hover:bg-cyan-600 transition-all duration-300 hover:scale-105 shadow-lg shadow-cyan-600/20 dark:shadow-cyan-500/20"
                            >
                              Website
